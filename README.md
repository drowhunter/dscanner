...
Each axis is normalized to `-1.0..1.0`. Its first sample is treated as the resting baseline; the application logs once when movement from that baseline reaches `0.25`, then rearms after returning within `0.20`.
